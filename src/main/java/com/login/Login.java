...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        this.ajustarImagen(this.lblimagen, "/main/java/com/images/mercado1.gif");
        this.ajustarImagen(this.logotipo, "/main/java/com/images/logotipo.png");
    }
    ...
    private void initComponents() {
        ...
        bg.setForeground(new java.awt.Color(51, 102, 255));
        ...
        bg.add(header, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 830, 30));
        ...
        logotipo.setFont(new java.awt.Font("Roboto Black", 1, 24)); // NOI18N
        bg.add(logotipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 80, 60));

        lblimagen.setBackground(new java.awt.Color(0, 134, 190));
        bg.add(lblimagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 40, 300, 500));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(bg, javax.swing.GroupLayout.DEFAULT_SIZE, 560, Short.MAX_VALUE)
        );
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseClicked
        ...
        String contraseñaIngresada = String.valueOf(passTxt.getPassword());

        conexionsql conexion = new conexionsql();
        conexion.conectar();
        boolean credencialesValidas = conexion.verificarCredenciales(usuarioIngresado, contraseñaIngresada);
        conexion.cerrar();
    ...
    try {
        ...
        String rutaAbsoluta = "C:/Users/Dell-Latitude/Documents/proyectoSoftware-master/src" + ruta;
        ImageIcon imagenIcon = new ImageIcon(rutaAbsoluta);
        Image imagen = imagenIcon.getImage().getScaledInstance(
                lbl.getWidth(),
                lbl.getHeight(),
                Image.SCALE_DEFAULT
        );
        ...
        System.err.println("Error al ajustar la imagen: " + e.getMessage());
        e.printStackTrace();
    }
}
